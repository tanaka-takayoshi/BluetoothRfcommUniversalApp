...
namespace BluetoothRfcommUniversalApp
{
    ...
    {
        public Guid BluetoothServiceUuid = BluetoothRfcommGlobal.BluetoothServiceUuid;
        public string BluetoothServiceDisplayName = BluetoothRfcommGlobal.BluetoothServiceDisplayName;
        public WindowsBluetoothRfcommServer BluetoothRfcommServer;
        public WindowsPhoneBluetoothRfcommClient BluetoothRfcommClient;
        ...
        async void RestoreBluetoothClient()
        {
            //TODO
            //if (ApplicationConfiguration.AutoStart == true)
            //{
            //    if (!string.IsNullOrEmpty(ApplicationConfiguration.ConnectedDeviceHostName))
            //    {
            //        BluetoothDevice d = new BluetoothDevice(ApplicationConfiguration.ConnectedDeviceHostName, ApplicationConfiguration.ConnectedDeviceServiceName, ApplicationConfiguration.ConnectedDeviceDisplayName);
            //        if (d != null)
            //        {
            //            BluetoothClientReturnCode r = await BluetoothRfcommClient.Connect(d);
            //        }
            //    }
            //}
        }
        ...
        protected async override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            {
                if (BluetoothRfcommClient.GetState() == BluetoothClientState.Created)
                {
